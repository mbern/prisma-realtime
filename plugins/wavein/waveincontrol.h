...
#include "waveincontrolbase.h"

#include <qmap.h>

class ObjectNode;

class WaveInControl : public WaveInControlBase
{
	Q_OBJECT
public:
	WaveInControl( ObjectNode * config, QWidget* parent = 0, const char* name = 0, Qt::WFlags fl = 0 );
	~WaveInControl();
...
protected slots:
	...
	virtual void inputChannelChanged( int );
